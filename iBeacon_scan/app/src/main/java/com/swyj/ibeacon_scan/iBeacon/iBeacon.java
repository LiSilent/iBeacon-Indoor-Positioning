...
import com.swyj.ibeacon_scan.utils.WirelessPropagation;
import com.swyj.ibeacon_scan.utils.utils;
...
public class iBeacon implements Comparable<iBeacon> {
    ...
    //无线电衰减模型参数
    private double txPower = -55;      //距离该结点1米处的RSSI值
    private double para_n = 2;
    //iBeacon设备自身所带参数
    private List<Double> RSSI_Value = new ArrayList<>(); //存储多个RSSI值
